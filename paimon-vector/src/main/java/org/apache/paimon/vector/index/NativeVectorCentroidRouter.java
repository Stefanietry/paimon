...
public class NativeVectorCentroidRouter implements Closeable {
    ...
    private final IvfTrainingModel model;
    ...
    public NativeVectorCentroidRouter(
        ...
        this.model =
                asIvfTrainingModel(
                        NativeVectorTrainingModelLoader.load(fileReader, globalIndexFile));
    }

    public int[] route(float[] queryVector, int nprobe) {
        return model.routingModel().nearestCentroids(queryVector, nprobe);
    }
